...
public class HomeController {
    ...
    public static String API_GET_STREAMABLE_MOVIES = Api.baseURL + "/api/stream-movie/available";
    ...
    public String displayHomePage(Model model){
        ...
        // Lấy phim có thể stream
        ResponseEntity<MovieDTO[]> responseStreamableMovies = restTemplate.getForEntity(API_GET_STREAMABLE_MOVIES, MovieDTO[].class);
        MovieDTO[] streamableMovies = responseStreamableMovies.getBody();
        ...
        model.addAttribute("streamableMovies", streamableMovies); // Dữ liệu phim có thể stream
